...
gain.more.than.houndred.samples <- which(rowSums(scores.matrix == 1) > 100)

# loss in more than 100 samples
loss.more.than.houndred.samples <- which(rowSums(scores.matrix == -1) > 100)

Heatmap(scores.matrix[c(gain.more.than.ten.samples,loss.more.than.ten.samples),],
